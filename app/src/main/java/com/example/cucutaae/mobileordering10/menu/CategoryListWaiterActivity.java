...
public class CategoryListWaiterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //Init adapter
                adapter = new MenuCategoryAdapter(CategoryListWaiterActivity.this, R.layout.category_image_item, imgList);
        ...
        final String userType =  getIntent().getStringExtra("USER_TYPE");
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(CategoryListWaiterActivity.this, AddProductActivity.class);
                    CategoryListWaiterActivity.this.startActivity(intent);
