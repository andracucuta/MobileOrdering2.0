...
/*        LatLng hcmus = new LatLng(44.449440, 26.123498);
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(hcmus, 18));
        originMarkers.add(mMap.addMarker(new MarkerOptions()
                .title("Magazinul Obor")
                .position(hcmus)));
        ...
        refLocation.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    restaurantPin = new LatLng(Double.parseDouble(location.getLatitude()),
                    ...
                    mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(restaurantPin, 18));
